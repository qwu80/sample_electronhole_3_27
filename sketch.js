...
vertex(250*s_x, (10+385/2+96.25) * s_y)
// vertex(new_array_rou_h_set_Efield[0].x, new_array_rou_h_set_Efield[0].y)
...
vertex(250 * s_x+((400)/8*count_pn_num)*s_x, (10+385/2+96.25) * s_y)
// vertex(new_array_rou_h_set_Efield[new_array_rou_h_set_Efield.length-1].x, new_array_rou_h_set_Efield[new_array_rou_h_set_Efield.length-1].y)
...
endShape();
    ...
    vertex(250 * s_x+((400)/8*0.2)*s_x, (10+385/2+96.25) * s_y)
    // vertex(new_array_rou_h_set_Efield[new_array_rou_h_set_Efield.length-1].x, new_array_rou_h_set_Efield[new_array_rou_h_set_Efield.length-1].y)
      ...
      if (sceneCount==2) {
        ...
        for (let k = 0; k < Math.round(count_pn_num*100); k++) {
          ...
          // } else {
            ...
            let E = (10+385/2+96.25)*s_y-3.8*Math.pow(10,-16)*hole_add_new*(Math.round(count_pn_num*100)-(10*k/10)*s_x)*3
            // console.log(n)
